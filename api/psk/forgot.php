        ...
        if($num==0){
            ...
            if($query->execute()){
                ...
                $output = '
                    ...
                    <body>
                        <div class="container">
                            <img src="http://localhost:3000/images/logo.png" alt="SokoLangu" width="50" height="50"/>
                            <h1>Password Reset Request</h1>
                            <p>Dear ' . $row['Username'] . ',</p>
                            <p>Please click the button below to reset your password:</p>
                            <p><a class="btn" href="http://localhost:3000/reset?token=' . $Token . '&email=' . $email . '" target="_blank" style="color: #fff;">RESET NOW</a></p>
                            ...
                            <p>Thanks for using SokoLangu 😉</p>
                            <br>
                            <p>Warm Regards</p>
                            <p>Juma Chaje</p>
                            <p>Founder, SokoLangu</p>
                        </div>
                    </body>
                    </html>
                    ';
                ...
                $body = $output;
                $subject = "Password Recovery - SokoLangu";
