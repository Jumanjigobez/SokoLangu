...
if ($uploaded_image) {
    ...
    $query->bind_param("ssssssssssss", $username, $first_name, $last_name, $phone_no, $email, $region, $role, $hashed_psk, $status, $terms_agreed, $newImageName, $user_id);
} else {
    ...
    $query->bind_param("sssssssssss", $username, $first_name, $last_name, $phone_no, $email, $region, $role, $hashed_psk, $status, $terms_agreed, $user_id);
}
