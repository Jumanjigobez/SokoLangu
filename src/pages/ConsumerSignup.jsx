...
const ConsumerSignup = () => {
  ...
  const handleSignup = () => {
    ...
    } else if (!username_ref.current.value.match(username_regex)) {
    ...
    } else if (!firstName_ref.current.value.match(names_regex)) {
      errors.first_name = "Invalid Name";
    }

    if (!lastName_ref.current.value.trim()) {
      errors.last_name = "Last Name Required";
    } else if (!lastName_ref.current.value.match(names_regex)) {
    ...
    } else if (!psk_ref.current.value.match(psk_regex)) {
      errors.password =
        "Invalid Password, Minimum should be 8 e.g Password@2025";
    }
                ...
                <div className="input_group">
                  <div className="grouping check_group">
                    ...
                    <label htmlFor="check" className="check_label">
                      I Agree to SokoLangu's{" "}
                      <b onClick={openDialogPolicy}>Terms of Service</b> and{" "}
                      <b onClick={openDialogPolicy}>Privacy Policy</b>
                    </label>
                  </div>
          ...
          <div className="dialog_box policy_dialog">
            ...
            <div className="content_part">
              <div className="part_1">
                ...
                <p>
                  Welcome to SokoLangu! By registering and using our services,
                ...
                <ol>
                  <li>
                    ...
                    password. Any activity performed through your account is
                    your responsibility.
                  </li>
                  <li>
                    <strong>User Conduct:</strong> You agree to use SokoLangu
                    for lawful purposes only. Any fraudulent, misleading, or
                    harmful activity is strictly prohibited.
                  </li>
                  <li>
                    <strong>Marketplace Transactions:</strong> SokoLangu
                    provides a platform for market trade interactions. We do not
                    guarantee or oversee individual transactions between users.
                  </li>
                  <li>
                    <strong>Data Security:</strong> We implement security
                    measures to protect user data, but we cannot guarantee
                    absolute protection. Report any unauthorized account
                    activity immediately.
                  </li>
                  <li>
                    <strong>Service Availability:</strong> While we aim to
                    maintain uninterrupted service, periodic maintenance or
                    updates may occur. We will communicate planned service
                    interruptions where possible.
                  </li>
                  <li>
                    <strong>Termination of Account:</strong> We reserve the
                    right to suspend or terminate accounts involved in
                    violations of these terms, fraud, or misuse of the platform.
                  </li>
                  <li>
                    <strong>Changes to Terms:</strong> We may revise these terms
                    from time to time. Continued use of SokoLangu signifies
              ...
              <div className="part_2">
                ...
                <p>
                  At SokoLangu, we value and respect your privacy. This policy
                  outlines how we handle your personal data:
                </p>
                <ol>
                  <li>
                    <strong>Information Collection:</strong> We collect your
                    username, email, and password for account registration.
                    Additional marketplace data may be gathered to enhance your
                    user experience.
                  </li>
                  <li>
                    <strong>Data Usage:</strong> Your personal information is
                    used solely for providing and improving SokoLangu services.
                  ...
                  <li>
                    <strong>Cookies:</strong> SokoLangu may use cookies to
                    enhance your experience. You may modify your browser
                    settings to disable cookies.
                  </li>
                  <li>
                    <strong>Third-party Links:</strong> Our platform may contain
                    links to external sites. We are not responsible for the
                    privacy policies of third-party services.
                  </li>
                  <li>
                    <strong>Children’s Privacy:</strong> SokoLangu is not
                    intended for users under 13. We do not knowingly collect
                    data from minors.
                  </li>
                  <li>
                    <strong>Policy Updates:</strong> We may update this policy
                    periodically. Significant changes will be communicated to
                    users.
                  </li>
                </ol>
              </div>
              ...
              <div className="part_3">
                <p>
                  For any questions or concerns about our terms or privacy
