        ...
        switch (type) {
            case "region":
                if (value === "All") {
                    ...
                    filteredData = productsData.filter((product) => product.Region === value);
                }
                break;
            ...
            case "category":
                if (value === "All") {
                    ...
                    filteredData = productsData.filter((product) => product.Category === value);
                }
                break;

            case "latest":
                filteredData = productsData.slice().sort((a, b) => new Date(b.UploadDate) - new Date(a.UploadDate));
                break;
                    ...
                    <div className='search_part'>
                        <form className='search_form' onSubmit={(e) => handleSearchProduce(e)}>
                            <div className='input_group'>
                                <input type='text' name='search' className='search' placeholder='Search fresh produce near you...' defaultValue={search_term} ref={search_input} required />
                            </div>
                        ...
                        <div className='part_1 filter_part'>
                            ...
                            <div className='custom_select'>
                                <select
                                    ...
                                    name='region'
                                    defaultValue={
                                        Array.isArray(filteredProductsData) && filteredProductsData.length !== 0
                            ...
                            <div className='custom_select'>
                                <select id='category_select' name='category'
                                    defaultValue={filteredProductsData.length !== 0
                                        ? filteredProductsData.map((row) => row.Category)
                                        : ""}

                                    onChange={(e) => handleSearchFilter("category", e.target.value)}
                            ...
                            <div className='custom_select'>
                                <select id='sort_select' name='sort'
                                    ...
                                    onChange={(e) => handleSearchFilter(e.target.value, e.target.value)}
                                >
