...
const Messages = () => {
    ...
    const handleSendMessage = (e) => {
        ...
        axios.post(api_url + "/Messages/sendChat.php", {
            consumer_id: user, // Logged-in consumer (Sender)
            farmer_id: selectedUser.partner_id, // Selected farmer (Receiver)
            msg: message
        ...
        <>
            ...
            <section className='get_started messages_container'>
                <div className='go_back' style={{ margin: '1rem' }}>
                    <button className='btn btn4 normal' onClick={() => navigate("/")}>Go back</button>
                </div>
                                    ...
                                    <div className='users'>
                                        {
                                            processedMessagesData.length !== 0 ? (
                                                ...
                                                <div className='empty'>
                                                    <p style={{ color: "var(--black)", fontWeight: "bold" }}>No Farmers Found! Please Place Order</p>
                                                </div>
                                            )
                                        }
                                    </div>
